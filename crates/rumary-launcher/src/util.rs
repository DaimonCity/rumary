...
pub async fn save_json<J: Serialize> (
    json_path: &Path, json_to_save: &J
    ...
    let data = {
        serde_json::to_vec(json_to_save)?
    };
...
pub async fn assets_json_is_valid(client_path: &str, version_json: &VersionJson) -> Result<(), PathBuf> {
